...
# Great! Now, add a ForeignKeyField to your LunchOrder model. Name it user.
# user should be related to the User model and the related_name should be "orders".
...
class LunchOrder(Model):
    order = TextField()
    date = DateField()
    user = ForeignKeyField(rel_model=User, related_name="orders")
