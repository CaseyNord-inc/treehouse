# Used in Logging video in Writing Better Python course.
...
def game_loop():
    ...
    logging.info("player: {}; monster: {}; map: {}; door: {}; key: {}; sword: {}; orb: {}".format(player, monster, game_map, door, key, sword, secret_orb))
    playing = True
    monster_turn = True
    found_map = False
    found_door = False
